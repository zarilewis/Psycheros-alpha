...
/**
 * The Pulse icon SVG (heartbeat monitor line — same as System Admin).
 */
...
export function pulseIndicatorSvg(): string {
  return `<svg class="pulse-indicator" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" title="Active Pulse">
